...
# -*- coding: utf-8 -*-
#
# OCAtari documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'ocatari', 'OCAtari Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OCAtari', 'OCAtari Documentation',
     author, 'OCAtari', 'One line description of project.',
     'Miscellaneous'),
]
