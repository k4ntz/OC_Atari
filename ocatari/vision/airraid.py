...
def _detect_objects(objects, obs, hud=False):
    ...
    for b in colored_damaged_buildings:
        ...
        # if already_extracted == False:
    #     #     objects.append(Building(*b))
    all_buildings = grayscaled_undamaged_buildings + grayscaled_damaged_buildings + \
                    colored_undamaged_buildings + colored_damaged_buildings
