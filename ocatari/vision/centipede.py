...
def _detect_objects(objects, obs, hud=False):
    ...
    objcolor = base_colors[(
        lvl+objects_offsets['player_and_projectile_and_wall']) % 8]
    player_and_walls = find_objects(
        obs, objcolor, min_distance=1, closing_dist=1)
    ...
    if hud:
        life_and_score = find_objects(
            obs, life_and_score_c, min_distance=1, closing_dist=1)
