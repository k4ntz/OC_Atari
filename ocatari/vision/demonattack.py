...
objects_colors = {'player': [184, 70, 162],
                  ...
                  'enemy': [
                      [72, 160, 72],
                      [84, 92, 214], [84, 138, 210], [84, 160, 197], [
                          84, 184, 153], [92, 186, 92],
                      [101, 111, 228], [104, 72, 198], [
                          127, 92, 213], [149, 111, 227],
                      [181, 108, 224], [195, 144, 61], [197, 124, 238],
                      [212, 108, 195], [213, 130, 74], [
                          214, 92, 92], [214, 214, 214],
...
def _detect_objects(objects, obs, hud=False):
    ...
    if hud:
        score = find_objects(
            obs, objects_colors["score"], min_distance=1, closing_dist=5, maxy=20)
        for s in score:
    ...
    proj_friendly = find_objects(
        obs, objects_colors['projectile_friendly'], min_distance=1)
    for proj in proj_friendly:
        objects.append(ProjectileFriendly(*proj))

    proj_hostile = find_objects(
        obs, objects_colors['projectile_hostile'], min_distance=1)
