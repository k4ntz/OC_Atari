...
def _detect_objects(objects, obs, hud=False):
    ...
    if wall_color in objects_colors["explosion"]:
        ...
        # extremely slow
        walls = find_exact_bounding_boxes(obs, wall_color, minx=10, maxx=150, miny=37, maxy=187)    
    ...
    if hud:
        ...
        gas = find_mc_objects(obs, objects_colors["gaz"], maxy=40, closing_dist=2, all_colors=False)
